...
from main.views import show_main, create_news, show_news, show_xml, show_json, show_json_by_id, show_xml_by_id, register, login_user, logout_user, edit_news, delete_news, proxy_image, create_news_flutter
